...
The PURE composition of a persona's fail-closed egress, plus the injected Tor-detection seam, per spec decisions 3 + 4 + 5. Each persona gets ONE socks5h endpoint; two ways to obtain one.
